...
export default function CommandCenterPage() {
  ...
  const coverage = getCompetitiveCoverage();
  const coverageFocus = coverage
  ...
  return (
    <>
      ...
      <section className="portfolio-strip" aria-label="Portfolio summary">
        <div>
          <span>Suite pillars</span>
          <strong>{portfolio.pillars}</strong>
        </div>
        <div>
          <span>Now</span>
          <strong>{portfolio.now}</strong>
        </div>
        <div>
          <span>Next</span>
          <strong>{portfolio.next}</strong>
        </div>
        <div>
          <span>Later</span>
          <strong>{portfolio.later}</strong>
        </div>
        <div className="portfolio-risk">
          <span>High gaps</span>
          <strong>{portfolio.highGaps}</strong>
        </div>
      </section>
      ...
      <div className="director-grid">
        <section className="card decision-panel">
          <div className="section-heading compact">
            <div>
              <div className="eyebrow">Leadership queue</div>
        ...
        <section className="card coverage-panel">
          <div className="section-heading compact">
            <div>
              <div className="eyebrow">Competitor analysis</div>
            ...
            {coverageFocus.map((row) => (
              <div className={row.companyId === "xai" ? "coverage-row is-grok" : "coverage-row"} key={row.companyId}>
                <div className="coverage-label">
                  ...
                  <span>{row.knownCoveragePercent}%</span>
                </div>
